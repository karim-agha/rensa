...
pub struct ErrorsMap {
  inner: IndexMap<Multihash, ContractError>,
...
impl std::ops::Deref for ErrorsMap {
  type Target = IndexMap<Multihash, ContractError>;
...
#[derive(Default, Serialize, Deserialize)]
pub struct LogsMap {
  inner: IndexMap<Multihash, Vec<(String, String)>>,
...
impl std::ops::Deref for LogsMap {
  type Target = IndexMap<Multihash, Vec<(String, String)>>;
